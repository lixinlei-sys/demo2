...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统用户表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_user` VALUES (7, 'sans', '$2a$10$NTmhjkOBcf1W8oHat7Spk.bJ9gJDYR/6tH6TpKzHDH41MAwoN/7h.', 'NORMAL');
INSERT INTO `sys_user` VALUES (8, 'lixinlei', '$2a$10$5L4E0kaA2199Z.YFFp6Hf.klWErv.FVNIbrArPNhTasrnTu7a9DSK', 'NORMAL');
...
CREATE TABLE `sys_user_role`  (
  ...
  `role_id` bigint(0) NULL DEFAULT NULL COMMENT '角色ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户与角色关系表' ROW_FORMAT = Dynamic;
